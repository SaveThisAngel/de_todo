...
novalido_lbl = ttk.Label(win, text = "",foreground="red",background="light blue",font=('Helvetica', 12, 'bold'))
...
boton_imagen = boton0 = Button(win, width=200, height=160, image= imagen, bg = 'white')
